...
class Polsosbud extends CI_Controller {
	...
	public function __construct()
    {
		...
		$this->load->model('M_polsusbud');
    }

	public function index()
	{
		$data['title'] = "Politik, Sosial Budaya dan Sumber Daya Organisasi";
		$data['konten'] = "index";
		...
		$data['model'] = $this->M_polsusbud;
		$data['dataProvider'] = $this->M_polsusbud->select_all();
		
		// $this->load->view('template/layout', $data);
		$this->template->views('page/polsusbud/index', $data);
	}
	...
	public function view($id) {
		$data['data'] = $this->M_polsusbud->selectId($id);
