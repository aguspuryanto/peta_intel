...
class M_dapil extends CI_Model {
    public $table_name = "epak_dapil";

    public function rules()
    {
        return [
            ['field' => 'thn', 'label' => 'Tahun', 'rules' => ''],
            ['field' => 'nama_dapil', 'label' => 'Nama Dapil', 'rules' => 'required'],
            ['field' => 'nama_wilayah', 'label' => 'Wilayah Dapil', 'rules' => 'required'],
            ['field' => 'jml_kursi', 'label' => 'Jumlah Kursi', 'rules' => 'required'],
        ];
    }    
